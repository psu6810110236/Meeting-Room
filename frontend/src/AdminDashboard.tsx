...
function AdminDashboard() {
    ...
    // ✨ Widget KPI Design: ดู Modern เหมือน Widget iOS
    const KPICard = ({ title, value, icon, color }: any) => (
        ...
        >
            {/* วงกลม Gradient จางๆ ตกแต่งด้านหลัง */}
            ...
            <Box sx={{ zIndex: 1 }}>
                <Typography variant="body2" color="text.secondary" fontWeight="700" sx={{ textTransform: 'uppercase', letterSpacing: '1px', fontSize: '0.7rem' }}>
                    {title}
                </Typography>
                <Typography variant="h3" fontWeight="800" sx={{ mt: 1, color: '#1e293b', letterSpacing: '-1px' }}>
                    {value}
                </Typography>
            </Box>
